...
public:
    ...
    typedef otb::StreamingStatisticsMapFromLabelImageFilter2<FeatureImageType, ClassImageType>
...
private:
    ...
    void DoExecute() override
    {
        ...
        auto redEdge = GetParameterInt("rededge") != 0;
        const float pixSize = redEdge ? 20.0f : 10.0f;
